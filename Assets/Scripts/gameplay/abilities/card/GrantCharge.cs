...
{
    public class GrantCharge : CardAbility
    {
        private Targets target;
        private int amount;
        private int index;
        public GrantCharge(Targets target,  int amount) : base()
        {
            this.index = index;
            this.target = target;
            this.amount = amount;
        ...
        {
            yield return new GrantChargeCommand(MatchState.PlayerComposition(), target, amount);
        }
    }
}